    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item>
                    <i class="el-icon-lx-cascades"/> Fs管理
                </el-breadcrumb-item>
            </el-breadcrumb>
        </div>
            ...
            <div class="form-box">
                <el-form ref="form" :model="formSearch" label-width="80px">
                    <el-radio-group v-model="formSearch.resource">
                        <el-radio label="有效Fs" @change="queryChange(1)"/>
                        <el-radio label="无效Fs" @change="queryChange(0)"/>
                    </el-radio-group>
                </el-form>
            </div>
        </div>
...
<script>
    import {fetchData} from '../../api/fsConfig';
    import service from "../../utils/request";

    export default {
        name: 'fsConfigBaseTable',
        data() {
            return {
                showInvalid: 1,
                showAvila: 0,//控制按钮显示
        ...
        methods: {
            ...
            // 新增路由跳转
            jmpAdd() {
                this.$router.push('/new-fs-config-form')
            },
            // 设置无效
            setAvail(isAbled) {
                let that = this;
