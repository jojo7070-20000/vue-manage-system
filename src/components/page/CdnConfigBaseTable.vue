    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item>
                    <i class="el-icon-lx-cascades"/> Cdn管理
                </el-breadcrumb-item>
            </el-breadcrumb>
        </div>
            ...
            <div class="form-box">
                <el-form ref="form" :model="formSearch" label-width="80px">
                    <el-radio-group v-model="formSearch.resource">
                        <el-radio label="有效cdn" @change="queryChange(1)"/>
                        <el-radio label="无效cdn" @change="queryChange(0)"/>
                    </el-radio-group>
                </el-form>
            </div>
        </div>
        ...
        <div class="container">
            ...
            >
                ...
                <el-table-column prop="address" label="域名">
...
<script>
    import {fetchData} from '../../api/cdnConfig';
    import service from "../../utils/request";

    export default {
        name: 'cdnConfigBaseTable',
        data() {
            return {
                showInvalid: 1,
                showAvila: 0,//控制按钮显示
        ...
        methods: {
            ...
            // 新增路由跳转
            jmpAdd() {
                this.$router.push('/new-cdn-config-form')
            },
            // 设置无效
            setAvail(isAbled) {
                let that = this;
                this.multipleSelection.forEach(function (p1, p2, p3) {
                    ...
                    p1.isAbled = isAbled;
                    service.post("/cdn/config/modify",
                        {
                            "isAbled": p1.isAbled,
                            "id": p1.id
                        })
